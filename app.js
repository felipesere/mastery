...
var _user$project$Lesson$Lesson = F3(
	function (a, b, c) {
		return {detailsOpen: a, title: b, subtitle: c};
	});

var _user$project$Card$render = F2(
	function (external, lesson) {
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(lesson.title),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(lesson.subtitle),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
...
var _user$project$Main$init = {
	ctor: '::',
	_0: {detailsOpen: false, title: 'Something', subtitle: 'Else'},
	_1: {
		ctor: '::',
		_0: {detailsOpen: true, title: 'Foo', subtitle: 'Bar'},
		_1: {ctor: '[]'}
	}
};
