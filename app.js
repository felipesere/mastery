...
var _user$project$Lesson$defaults = function (lesson) {
	return {lesson: lesson, detailsOpen: false};
};
var _user$project$Lesson$Lesson = F2(
	function (a, b) {
		return {title: a, subtitle: b};
	});
var _user$project$Lesson$decode = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$Lesson$Lesson,
	A2(_elm_lang$core$Json_Decode$field, 'title', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'subtitle', _elm_lang$core$Json_Decode$string));
var _user$project$Lesson$decodeList = _elm_lang$core$Json_Decode$list(_user$project$Lesson$decode);
var _user$project$Lesson$LessonExtras = F2(
	function (a, b) {
		return {lesson: a, detailsOpen: b};
	});

var _user$project$Card$render = F2(
	function (external, _p0) {
		var _p1 = _p0;
		var _p2 = _p1.lesson;
		return A2(
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('card-content content'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(_p2.subtitle),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(external),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('button card-footer-item'),
											_1: {ctor: '[]'}
										}
									},
									{
...
var _user$project$ModuleCatalog$flexible = {
	ctor: '::',
	_0: _seanhess$elm_style$Style$display('flex'),
	_1: {
		ctor: '::',
		_0: _seanhess$elm_style$Style$flexWrap(_seanhess$elm_style$Style$wrap),
		_1: {
			ctor: '::',
			_0: _seanhess$elm_style$Style$alignContent(_seanhess$elm_style$Style$flexStart),
			_1: {
				ctor: '::',
...
var _user$project$ModuleCatalog$render = F2(
	function (lessons, external) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$style(_user$project$ModuleCatalog$flexible),
					_1: {ctor: '[]'}
				}
			},
			A2(
				_elm_lang$core$List$map,
				_user$project$Card$render(external),
				lessons));
	});
...
var _user$project$Main$extraftFrom = function (result) {
	var _p0 = result;
	if (_p0.ctor === 'Ok') {
		return A2(_elm_lang$core$List$map, _user$project$Lesson$defaults, _p0._0);
	} else {
		return {ctor: '[]'};
	}
};
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		if (_p1.ctor === 'None') {
			...
			return {
				ctor: '_Tuple2',
				_0: _user$project$Main$extraftFrom(_p1._0),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		}
	});
var _user$project$Main$loadLessons = A2(_elm_lang$http$Http$get, 'http://localhost:3000/modules', _user$project$Lesson$decodeList);
var _user$project$Main$LoadModules = function (a) {
	return {ctor: 'LoadModules', _0: a};
};
var _user$project$Main$send = A2(_elm_lang$http$Http$send, _user$project$Main$LoadModules, _user$project$Main$loadLessons);
...
var _user$project$Main$view = function (model) {
	return A2(_user$project$ModuleCatalog$render, model, _user$project$Main$None);
};
