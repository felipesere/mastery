defmodule MasteryBackendWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :mastery_backend
  ...
  plug Plug.Session,
    store: :cookie,
    key: "_mastery_backend_key",
    signing_salt: "G4T+xNET"

  plug MasteryBackendWeb.Router
