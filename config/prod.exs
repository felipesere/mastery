...
# MasteryBackendWeb.Endpoint.init/2 when load_from_system_env is
...
config :mastery_backend, MasteryBackendWeb.Endpoint,
  ...
  url: [scheme: "https", host: "path2mastery.herokuapp.com", port: 443],
...
# start per endpoint:
#
#     config :mastery_backend, MasteryBackendWeb.Endpoint, server: true
#
